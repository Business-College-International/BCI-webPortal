  ...
  return (
    <section className="card">
      ...
      <div className="filter-grid">
        <label>
          Search
          <input value={q} onChange={(event) => setQ(event.target.value)} placeholder="Name or admission number" />
        </label>
        <label>
          Status
        ...
        <label>
          ...
          <select value={programme} onChange={(event) => setProgramme(event.target.value)}>
            {programmes.map((value) => <option key={value} value={value}>{value || 'All programmes'}</option>)}
          </select>
        </label>
      </div>
